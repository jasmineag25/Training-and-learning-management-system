...
func submitEducatorRequest(name : String , aadharImage: UIImage, profileImage: UIImage, email: String, mobileNumber: String , qualification: String, experience : String, subjectDomain: String, language : String, about : String, completion: @escaping (Bool) -> Void) {
